...
const Copyright = ({ nomeEmpresa, urlEmpresa }) => {
  return (
    <Typography 
      variant="body2" 
      color="textSecondary" 
    ...
    >
      ...
      <Link 
        color="inherit" 
        href={urlEmpresa || "https://www.exemplo.com"}
...
const useStyles = makeStyles((theme) => ({
  root: {
    minHeight: '100vh',
    background: 'linear-gradient(45deg, #10aa62 0%, #10aa62 100%)',
    display: 'flex',
    alignItems: 'center',
  ...
  sentAnimation: {
    position: 'relative',
    background: 'linear-gradient(45deg, #0d120f, #0d120f)',
    '&:after': {
      content: '"✉️"',
      position: 'absolute',
      fontSize: '24px',
